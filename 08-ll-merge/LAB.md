...
Create a branch in your repository called ll_merge
On your branch, create…
C#: Create a method named Merge() outside of Main() in your Program.cs file. Call Your newly created method in Main() once complete.
JavaScript: a file called ll_merge.js
Python: a file called ll_merge.py
